...
@XmlRootElement(name = "OpenTicketRequest")
public class OpenTicketRequest {
    ...
    public OpenTicketRequest(String PlayerId, String SessionToken, long TicketNumber, float Stake, String CurrencyCode, GlobalBetAuthorizationPjo Authorization){
